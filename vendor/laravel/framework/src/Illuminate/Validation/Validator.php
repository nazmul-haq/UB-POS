...
class Validator implements MessageProviderInterface {
	...
	protected function isAValidFileInstance($value)
	{
        ...
        /**
	 * Validate that an attribute contains only alpha space characters.
	 *
	 * @param  string  $attribute
	 * @param  mixed   $value
	 * @return bool
	...
	protected function validateAlphaDash($attribute, $value)
	{
        ...
        /**
	 * Validate that an attribute contains only numeric and float value.
	 *
	 * @param  string  $attribute
	 * @param  mixed   $value
	 * @return bool
	 */
        protected function validateNumberDot($attribute, $value)
	{
