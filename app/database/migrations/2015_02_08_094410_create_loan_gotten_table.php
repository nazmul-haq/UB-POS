...
class CreateLoanGottenTable extends Migration {
	...
	public function up()
	{
		Schema::create('LoanGottens', function(Blueprint $table)
		{
                        $table->increments('loan_gotten_id');
			...
			$table->timestamps();
                ...
                Schema::table('LoanGottens', function(Blueprint $table)
                {
                    $table->index('loan_gotten_id');
