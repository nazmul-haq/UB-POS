...
class CreateReceivingItem extends Migration {
	...
	public function up()
	{
		...
		{
                        $table->increments('receiving_item_id');
			...
			$table->timestamps();
                ...
                Schema::table('ReceivingItems', function(Blueprint $table)
                {
