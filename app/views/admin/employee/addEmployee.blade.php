				...
				<div class="widget-content">	
					<div class="row">
						<div class="span12">
							...
							{{ Form::open(array('route' => 'admin.saveEmployee.post', 'id' => 'validate_wizard', 'class' => 'stepy-wizzard form-horizontal')) }}	
								<fieldset title="Personal info">
									...
									<div class="formSep control-group">		
										...
										<div class="controls">
											{{ Form::select('role', ['' => 'Select Employee Type','0' => 'Store House','1' => 'Sales Man','2' => 'Super Admin'], null, array('class' => 'span8')) }}
