				...
				<div class="widget-content">	
					<div class="row">
						<div class="span12">						
							...
							{{ Form::model($empInfo, array('route' => 'admin.updateEmployee.post', $empInfo->emp_id, 'id' => 'validate_wizard', 'class' => 'stepy-wizzard form-horizontal')) }}	
								<fieldset title="Personal info">
									...
									<div class="formSep control-group">		
										...
										<div class="controls">
											{{ Form::select('role', ['0' => 'Store House','1' => 'Sales Man','2' => 'Super Admin'],$empInfo->role, array('class' => 'span8')) }}
									...
									<div class="formSep control-group">		
										{{ Form::label('v_username', 'Username', ['class' => 'control-label']) }}
										<div class="controls">
									...
									<div class="formSep control-group">		
										...
										<div class="controls">
											{{ Form::password('password', array('class' => 'span8', 'placeholder' => 'Enter Password')) }}
