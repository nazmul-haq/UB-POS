...
{{ Form::model($iteminfos,  array('route' => 'admin.editItemSave.post', $iteminfos->item_id, 'id' => 'addItemform', 'class' => 'form-horizontal')) }}
	{{ Form::hidden('item_id', $iteminfos->item_id)}}
	<div class="control-group">
		{{ Form::label('company_id', 'Company Name', ['class' => 'control-label']) }}
		<div class="controls">
			{{ Form::select('company_id', $company, $iteminfos->company_id, array('class' => 'span3', 'required' => 'required')) }}
		</div> <!-- /controls -->
	</div> <!-- /control-group -->
	<div class="control-group">
