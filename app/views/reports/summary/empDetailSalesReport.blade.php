	  ...
	  <div class="span12">
		@include('_sessionMessage')
			<div class="invoice-reg print_disable">
                {{ Form::open(array('route' => 'summary.viewEmpDtlSalesReport', 'class' => 'form-horizontal')) }}
					<div class="control-group" align="center">
						<i class="icon-calendar"></i>&nbsp; From : <input class="span2 datepicker" data-date-format="yyyy-mm-dd" placeholder="Form date" name="from" type="text" value="">
						&nbsp;&nbsp;&nbsp;
						<i class="icon-calendar"></i>&nbsp; To 	 : <input class="span2 datepicker" data-date-format="yyyy-mm-dd" placeholder="Form date" name="to" type="text" value="">
					</div> <!-- /control-group -->
					<div class="control-group" align="center">
					&nbsp; Select Employee : 
						<select name="emp_id">
							...
							@if(isset($emp_name))
								@if(Session::get('role')!=2)
										<option value="{{ Session::get('emp_id')}}">
											{{ Session::get('user_name') }}
										</option>
								@else
									@foreach($emp_name as $empname)
										<option value="{{$empname->emp_id}}">{{$empname->user_name}}</option>
									@endforeach
								@endif
							@endif
						</select>
