	  ...
	  <div class="span12">
		@include('_sessionMessage')
			<div class="invoice-reg print_disable">
                {{ Form::open(array('route' => 'spplierWisePurchase.report', 'class' => 'form-horizontal')) }}
            ...
            <article style="background: #EEEEEE; padding : 5px 0 7px; border-top: 1px solid #003454;">
				<strong style="font-size: 1.5em;"><i class="icon-credit-card"></i> Summary:: Supplier Wise Purchase Report</strong>
            ...
            {{ Datatable::table()
				->addColumn('Invoice Id','Supplier Name','Transaction Date','Payment Type','Discount','Amount','Paid','Due')
				->setUrl(url("summary/getspplierWisePurchaseData/$from/$to/$supplierId"))
				->render() 
			}}
	  	</div>
	</div>
