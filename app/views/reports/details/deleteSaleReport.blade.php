	  ...
	  <div class="span12">
		@include('_sessionMessage')
			<div class="invoice-reg print_disable">
                {{ Form::open(array('route' => 'deleteSaleReportView', 'class' => 'form-horizontal')) }}
		...
		@if(isset($reports))
		{{ Form::open(array('route' => 'deleteSaleInvoice.post', 'class' => 'form-horizontal','id' => 'submitForm')) }}
		<table class="table table-bordered" id="datatable">
			...
			<tbody>
				...
				@if($reports)
				   ...
				   <?php $i++;?>
					   <tr>
							<td class="" id="check_{{$invoice->sale_invoice_id}}"><input type="checkbox" name="saleInvoiceId_{{$i}}" value="{{$invoice->sale_invoice_id}}" />
							</td>
							<td>{{$i}}</td>
