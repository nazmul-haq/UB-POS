...
@section('content')
	...
	<div class="row">
        ...
        @if (Session::get('role')==2)
				...
				<a href="{{ route('summary.companyWiseSale') }}" class="setup-item">
					<i class="setup-icon icon-zoom-out"></i><span class="setup-label"> Company Wise Sale Report </span>
				</a>
        		@endif
        	@endif
			</div>
            ...
            <div class="widget-header setup-title"> <i class="icon-user"></i>
              ...
              <div class="setup-items"> 
              	 @if (Session::get('role')==2)
					...
					<a href="{{ route('summary.backDateStockReports') }}" class="setup-item"> 
						<i class="setup-icon icon-th-large"></i><span class="setup-label">Back Date Stock Report</span> 
					</a>
				 @endif
